...
"""
from Lapzbot import redis_manager, mongo_manager
from Lapzbot.Modules import utility, admin, emojis, custom_commands, fun, nsfw, weeb, games, imgur_async
import re
import discord
import json
import datetime
...
class Commands:
    ...
    async def log_message(self, message):
        ...
        if self.redis.exists(log_key):
            self.redis.incr("LAPZBOT_LOG_WRITES")
            new_record = {
    ...
    async def hastebin_handler(content, output_str):
        ...
        headers = {"Content-Type": "text/plain",
                   "User-Agent": "Lapzbot by Lapoozza (https://github.com/lapoozza/lapzbot)"}
